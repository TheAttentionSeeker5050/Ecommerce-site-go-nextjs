/*
-- Query: select * from ecommerce_db.product_pet_types
LIMIT 0, 1000

-- Date: 2023-07-23 01:14
*/
INSERT INTO ecommerce_db.product_pet_types (`id`,`created_at`,`updated_at`,`deleted_at`,`pet_name`,`url_formatted_name`,`image_thumbnail_url`) VALUES (1,NULL,NULL,NULL,'Dogs','dogs','https://imagedelivery.net/TCjTQ2jntwoaDOUnNfWb7Q/27fb63ea-dc82-4014-c384-653d165a3e00/public');
INSERT INTO ecommerce_db.product_pet_types (`id`,`created_at`,`updated_at`,`deleted_at`,`pet_name`,`url_formatted_name`,`image_thumbnail_url`) VALUES (2,NULL,NULL,NULL,'Cats','cats','https://imagedelivery.net/TCjTQ2jntwoaDOUnNfWb7Q/33ed6a85-d720-4d60-1b25-6df90879a600/public');
